(function () {
  ...
  var footerHTML = [
    ...
    '    <div class="row g-5">',
    '      <div class="col-lg-4">',
    '        <h5 class="text-center">Biancolor</h5>',
    '        <div class="footer-social">',
    '          <p class="text-center">Síguenos:</p>',
    '          <div class="social-links" style="display:flex; justify-content:center; gap:1rem;">',
    '            <a href="https://www.facebook.com/profile.php?id=61583909493357" target="_blank" aria-label="Facebook">',
    '              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="20" height="20">',
    '                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>',
    '              </svg>',
    '            </a>',
    '            <a href="https://www.instagram.com/biancolor_decoracion/" target="_blank" aria-label="Instagram">',
    '              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="20" height="20">',
    ...
    '      <p>&copy; 2026 Biancolor. Todos los derechos reservados.</p>',
    '    </div>',
    '  </div>',
    '</footer>'
  ].join('\n');
